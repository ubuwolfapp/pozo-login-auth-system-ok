...
async function initializeTestData() {
  try {
    ...
    await supabase.from("fotos_pozos").delete().neq("id", "");
    await supabase.from("presion_historial").delete().neq("id", "");
    await supabase.from("alertas").delete().neq("id", "");
    await supabase.from("tareas").delete().neq("id", "");
    await supabase.from("camaras_pozos").delete().neq("id", "");
    await supabase.from("pozos_mapas_relacion").delete().neq("id", "");
    await supabase.from("pozos").delete().neq("id", "");
    await supabase.from("pozos_mapa").delete().neq("id", "");
