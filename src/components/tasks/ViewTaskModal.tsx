...
import { AlertTriangle, Link as LinkIcon, Image as ImageIcon } from "lucide-react";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg">
        ...
        <div>
          ...
          <div className="bg-slate-100 rounded p-2 text-slate-800 min-h-[40px]">{task.descripcion || <span className="italic text-gray-500">Sin descripción</span>}</div>
        </div>
        {task.link && (
          <div className="mt-3">
            <a
